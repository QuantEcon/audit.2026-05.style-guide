...
|--------|---------:|--------:|-----:|------------------|
| lecture-python-advanced.myst | 68 | 7.8 | 39 | Math (5.6) |
| lecture-dp | 52 | 7.8 | 29 | Writing (5.6) |
| lecture-python-programming | 27 | 8.1 | 19 | Writing (4.1) |
| lecture-python.myst | 145 | 8.1 | 56 | Writing (5.9) |
| lecture-python-intro | 56 | 8.4 | 12 | Writing (6.3) |
| **Corpus** | **348** | **8.0** | **155** | Writing (5.8) |
<!-- /qe:readme-scoreboard -->
