...
### Low severity
- **[qe-math-A1]** *(carry-forward M7)* — `\mathbb P` without braces at line 1188; renders identically but inconsistent.
...
- Equation labels and `{eq}` references used correctly (e.g., `np_polynom` at line 1132 and `{eq}` ref at line 1137) per qe-math-A6.
