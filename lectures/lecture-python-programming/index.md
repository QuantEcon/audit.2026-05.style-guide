...
- **Average per-category scores:** writing 5.7, math 9.1, code 9.8, figures 7.2, links 9.9, admon 9.9  *(references not in scope for this series)*
...
2. **`qe-fig-005`** — Descriptive figure names for cross-referencing — **22 / 27** lectures, 137 occurrences.
...
5. **`qe-fig-008`** — Use lw=2 for line charts — **14 / 27** lectures, 65 occurrences.
...
|---|---------|---|---|---|---|---|---|---|---------|----------|
| 1 | [about_py](about_py.md) | 4.5 | — | 10 | 7 | — | 9 | — | **7.6** | LOW |
| 2 | [python_by_example](python_by_example.md) | 4 | 9 | 10 | 6 | — | 10 | 7.5 | **7.8** | HIGH |
| 3 | [numpy](numpy.md) | 3.5 | 8.5 | 9 | 7 | — | 10 | 10 | **8.0** | HIGH |
| 4 | [matplotlib](matplotlib.md) | 5.5 | 10 | 9 | 4 | — | 10 | 10 | **8.1** | HIGH |
| 5 | [numba](numba.md) | 4.5 | 7.5 | 10 | 7.5 | — | 9 | 10 | **8.1** | LOW |
| 6 | [scipy](scipy.md) | 4.5 | 7.5 | 8.5 | 8 | — | 10 | 10 | **8.1** | LOW |
...
| 17 | [writing_good_code](writing_good_code.md) | 4.5 | 10 | 10 | 7 | — | 10 | 10 | **8.6** | NONE |
| 18 | [autodiff](autodiff.md) | 8 | 7.5 | 10 | 6.5 | — | 10 | 10 | **8.7** | NONE |
| 19 | [python_essentials](python_essentials.md) | 3.5 | 10 | 10 | — | — | 10 | 10 | **8.7** | HIGH |
| 20 | [debugging](debugging.md) | 5 | 10 | 10 | 7.5 | — | 10 | 10 | **8.8** | NONE |
| 21 | [functions](functions.md) | 5 | 10 | 10 | 7.5 | — | 10 | 10 | **8.8** | NONE |
| 22 | [sympy](sympy.md) | 7.5 | 8 | 10 | 10 | — | 8 | 10 | **8.9** | NONE |
...
| 25 | [python_advanced_features](python_advanced_features.md) | 7.5 | — | 10 | 9 | — | 10 | 10 | **9.3** | NONE |
