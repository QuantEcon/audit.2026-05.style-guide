...
### Medium severity
- **[qe-math-A1]** — A few bare `E_t` instead of `\mathbb{E}_t` (carry-forward from v1 M7). *Example:* `lectures/amss2.md:557`, `:609`, `:619`. *Count:* 3 occurrences.
...
## Recommended actions
1. Replace remaining bare `E_t` with `\mathbb{E}_t` (qe-math-A1).
