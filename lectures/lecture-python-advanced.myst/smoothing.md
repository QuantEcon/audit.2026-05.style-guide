...
| Math         | 3/10  | `qe-math-010` (proposed) ×18; `qe-math-002` ×3; `qe-math-011` (proposed) ×1. |
...
- **[qe-math-010 (proposed)]** — Blackboard \mathbb{P}, \mathbb{E}, \mathbb{V} with braces. *Count:* 18. *Lines:* 177, 184, 190, 196, 199, 204, 236, 378, 381, 398, …. *Example:* missing braces: `\mathbb E`.
