...
7. Sweep the remaining mechanical and typographic items: `i.i.d.` to `IID` at 127, 146, 149, 481 (qe-writing-009 (proposed)), brace the bare expectations at 234, 380, 383, 405 as `\mathbb{E}` (qe-math-010 (proposed)), turn the seven raw quantecon URLs at 36, 56, 86, 412, 486, 498, 501 into `{doc}` references (qe-link-002), and fix the typos `the the` (227), `reprentation` (361) and `thid` (486).
