...
### High severity
- **[qe-math-A3]** — `\mathcal{N}` used systematically as Normal distribution (carry-forward from v1 M9). *Example:* `lectures/black_litterman.md:518`. *Count:* 16 occurrences.
...
### Medium severity
- **[qe-math-004]** — Bold used for vectors/matrices (carry-forward from v1 M5). *Example:* `lectures/black_litterman.md:518`, `:592`, `:812`, `:831`. *Count:* 4 occurrences.
