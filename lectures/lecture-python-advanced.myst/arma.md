...
6. Brace the three expectation operators - `\mathbb E X_t` (118), `\mathbb E (X_t - \mu)...` (119) and `\mathbb E \epsilon_t` (133) should be `\mathbb{E}` (qe-math-010 (proposed)) - and fix the Cauchy-Schwarz attribution at 169.
