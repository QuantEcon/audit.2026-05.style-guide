...
| Math         | 3/10  | `qe-math-010` (proposed) ×37; `qe-math-006` ×2; `qe-math-011` (proposed) ×1, +1 more. |
...
- **[qe-math-010 (proposed)]** — Blackboard \mathbb{P}, \mathbb{E}, \mathbb{V} with braces. *Count:* 37. *Lines:* 118, 122, 129, 144, 150, 156, 162, 174, 266, 307, …. *Example:* non-blackboard `\operatorname{cov}`.
...
3. Write the expectation and moment operators as the guide asks - $\mathbb{E}$ for the 26 bare `E`/`E(` uses (118, 144, 266, 307, 394, 414, 470, 477, 633, 640 and 16 more) and `\operatorname{cov}` / `\operatorname{var}` for the bare `Cov(` and `Var(` at 666 (qe-math-010, proposed, 26 occurrences - the largest single item here).
