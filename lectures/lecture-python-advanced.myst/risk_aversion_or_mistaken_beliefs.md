...
5. Sweep the 18 `\mathcal{N}` to plain `N` (qe-math-011 (proposed), proposed: 104, 125, 137, 152, 164, 219, 223, 251, 329, 361, 365, 372, 566, 574, 823, 925, 1574, 1593) and the 34 bare expectations to `\mathbb{E}` (qe-math-010 (proposed), proposed: 150, 152, 290, 832, 856, 870, 876, 909, 912, 917 and on), which will also settle whether $\mathcal M$ at 66 should keep its decoration.
...
9. Add a difference panel to the identification figure at 657-666, where the dashed red curve currently hides the solid blue one that 669 asks the reader to see is identical; and finish the small items - "i.i.d." at 246 (qe-writing-009 (proposed), proposed), the ten `figsize=` calls, the twelve figures without `mystnb` names, and the typos "countercyclical risk price" (37), "perpective" (37) and "Especial LRR parametric worry" (1560).
