...
| Math         | 6/10  | `qe-math-010` (proposed) ×7; `qe-math-009` ×2. |
...
- **[qe-math-010 (proposed)]** — Blackboard \mathbb{P}, \mathbb{E}, \mathbb{V} with braces. *Count:* 7. *Lines:* 61, 69, 559, 597, 1266, 1315, 1821. *Example:* bare expectation `E_0 \sum`.
