...
| Figures      | 6/10  | `qe-fig-003` ×4; `qe-fig-005` ×3; `qe-fig-008` ×8, +1 more. |
...
- **[qe-fig-008]** — Use lw=2 for line charts. *Count:* 8. *Lines:* 529, 530, 697, 699, 1039, 1040, 1046, 1047. *Example:* plot() without lw=.
