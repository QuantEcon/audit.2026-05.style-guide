...
| 2 | [lecture-python.myst](lecture-python.myst/index.md) | 145 | **5.3** | 7.2 | 8.2 | 6.5 | 9.6 | 9.8 | 10.0 | **8.0** | 69 | 1 | 27 | 48 |
...
|   | **TOTAL / corpus average** | **348** | **5.3** | **7.2** | **8.1** | **6.5** | **9.4** | **9.6** | **10.0** | **8.0** | **172** | **1** | **81** | **94** |
<!-- /qe:full-scoreboard -->
...
### 15. `qe-code-002` — Use Unicode symbols for Greek letters in code (49 / 348 lectures, 348 occurrences)
- `lecture-python.myst` 27 / 145 · `lecture-python-advanced.myst` 10 / 68 · `lecture-python-intro` 7 / 56 · `lecture-dp` 5 / 52
...
14. **Shared lectures between `lecture-dp` and `lecture-python.myst`.** 31 filenames
    ...
    18,629 findings — **1.2 % genuinely counted twice**, which is the honest size of the
