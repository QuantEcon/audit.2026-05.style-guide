...
|---|--------|----------|---|---|---|---|---|---|---|-------------|------|--------|-----|------|
| 1 | [lecture-python-advanced.myst](lecture-python-advanced.myst/index.md) | 68 | **4.6** | 5.9 | 7.4 | 6.3 | 9.2 | 9.2 | 10.0 | **7.4** | 44 | 0 | 19 | 5 |
| 2 | [lecture-dp](lecture-dp/index.md) | 52 | **5.6** | 6.8 | 8.1 | 6.4 | 9.3 | 9.5 | 10.0 | **7.9** | 28 | 0 | 12 | 12 |
| 3 | [lecture-python-programming](lecture-python-programming/index.md) | 27 | **4.1** | 9.0 | 8.5 | 7.3 | N/A | 9.8 | 9.9 | **8.1** | 19 | 0 | 5 | 3 |
| 4 | [lecture-python.myst](lecture-python.myst/index.md) | 145 | **5.7** | 7.2 | 8.4 | 6.5 | 9.6 | 9.8 | 10.0 | **8.1** | 57 | 1 | 40 | 47 |
| 5 | [lecture-python-intro](lecture-python-intro/index.md) | 56 | **6.3** | 8.7 | 8.3 | 6.5 | 9.3 | 9.7 | 10.0 | **8.4** | 12 | 0 | 20 | 24 |
|   | **TOTAL / corpus average** | **348** | **5.4** | **7.2** | **8.1** | **6.5** | **9.4** | **9.6** | **10.0** | **8.0** | **160** | **1** | **96** | **91** |
<!-- /qe:full-scoreboard -->
...
### 2. `qe-writing-008` — Remove excessive whitespace between words (237 / 348 lectures, 7123 occurrences)
...
### 4. `qe-fig-008` — Use lw=2 for line charts (216 / 348 lectures, 1382 occurrences)
- `lecture-python.myst` 80 / 145 · `lecture-python-advanced.myst` 43 / 68 · `lecture-dp` 39 / 52 · `lecture-python-intro` 39 / 56 · `lecture-python-programming` 15 / 27
...
### 7. `qe-writing-006` — Capitalize lecture titles properly (145 / 348 lectures, 780 occurrences)
- `lecture-python.myst` 77 / 145 · `lecture-python-programming` 23 / 27 · `lecture-dp` 22 / 52 · `lecture-python-intro` 15 / 56 · `lecture-python-advanced.myst` 8 / 68

### 8. `qe-math-010` (proposed) — Blackboard \mathbb{P}, \mathbb{E}, \mathbb{V} with braces (118 / 348 lectures, 1397 occurrences)
- `lecture-python.myst` 58 / 145 · `lecture-python-advanced.myst` 31 / 68 · `lecture-dp` 18 / 52 · `lecture-python-intro` 8 / 56 · `lecture-python-programming` 3 / 27

### 9. `qe-ref-001` — Use correct citation style (105 / 348 lectures, 282 occurrences)
- `lecture-python-advanced.myst` 35 / 68 · `lecture-python.myst` 35 / 145 · `lecture-dp` 20 / 52 · `lecture-python-intro` 15 / 56
...
### 11. `qe-code-002` — Use Unicode symbols for Greek letters in code (85 / 348 lectures, 447 occurrences)
- `lecture-python.myst` 38 / 145 · `lecture-python-advanced.myst` 20 / 68 · `lecture-dp` 19 / 52 · `lecture-python-intro` 8 / 56

### 12. `qe-link-002` — Use doc links for cross-series references (73 / 348 lectures, 205 occurrences)
...
### 13. `qe-math-002` — Use \top for transpose notation (66 / 348 lectures, 1612 occurrences)
- `lecture-python.myst` 25 / 145 · `lecture-python-advanced.myst` 20 / 68 · `lecture-dp` 16 / 52 · `lecture-python-intro` 4 / 56 · `lecture-python-programming` 1 / 27

### 14. `qe-fig-004` — Caption formatting conventions (63 / 348 lectures, 183 occurrences)
- `lecture-python.myst` 38 / 145 · `lecture-python-intro` 17 / 56 · `lecture-python-advanced.myst` 8 / 68

### 15. `qe-fig-006` — Lowercase axis labels (60 / 348 lectures, 298 occurrences)
...
### 22. `qe-code-003` — Package installation at lecture top (29 / 348 lectures, 36 occurrences)
- `lecture-python.myst` 9 / 145 · `lecture-dp` 7 / 52 · `lecture-python-advanced.myst` 6 / 68 · `lecture-python-intro` 4 / 56 · `lecture-python-programming` 3 / 27

### 23. `qe-math-001` — Prefer UTF-8 unicode for simple parameter mentions, be consistent (16 / 348 lectures, 30 occurrences)
- `lecture-python.myst` 9 / 145 · `lecture-dp` 3 / 52 · `lecture-python-intro` 2 / 56 · `lecture-python-advanced.myst` 1 / 68 · `lecture-python-programming` 1 / 27
...
### 26. `qe-math-008` — Explain special notation (vectors/matrices) (7 / 348 lectures, 7 occurrences)
- `lecture-python.myst` 3 / 145 · `lecture-dp` 2 / 52 · `lecture-python-advanced.myst` 1 / 68 · `lecture-python-intro` 1 / 56

### 27. `qe-math-005` — Use curly brackets for sequences (7 / 348 lectures, 14 occurrences)
- `lecture-python.myst` 3 / 145 · `lecture-dp` 2 / 52 · `lecture-python-advanced.myst` 1 / 68 · `lecture-python-intro` 1 / 56
...
### 31. `qe-math-012` (proposed) — Multiplication via \cdot or juxtaposition, never * (4 / 348 lectures, 6 occurrences)
- `lecture-python-intro` 2 / 56 · `lecture-python-programming` 1 / 27 · `lecture-python.myst` 1 / 145

### 32. `qe-fig-010` — Plotly figures require latex directive (4 / 348 lectures, 4 occurrences)
...
| advanced | [match_transport](lecture-python-advanced.myst/match_transport.md) | 3.0 | 9.5 | 5.0 | 3.0 | 8.5 | 8.0 | — | **6.2** | 3.0 |
| advanced | [tax_smoothing_2](lecture-python-advanced.myst/tax_smoothing_2.md) | 5.0 | 3.5 | 6.5 | 4.0 | 8.5 | 10.0 | — | **6.2** | 3.5 |
| python.myst | [two_auctions](lecture-python.myst/two_auctions.md) | 3.0 | 4.5 | 7.5 | 3.0 | 10.0 | 9.0 | — | **6.2** | 3.0 |
...
| python.myst | [perm_income_cons](lecture-python.myst/perm_income_cons.md) | 3.0 | 4.0 | 7.0 | 5.5 | 10.0 | 9.0 | — | **6.4** | 3.0 |
...
| python.myst | [two_computation](lecture-python.myst/two_computation.md) | 5.5 | 3.0 | 7.5 | 3.0 | 10.0 | 10.0 | — | **6.5** | 3.0 |
| advanced | [additive_functionals](lecture-python-advanced.myst/additive_functionals.md) | 5.5 | 3.5 | 7.0 | 3.5 | 9.0 | 7.5 | 10.0 | **6.6** | 3.5 |
| advanced | [dyn_stack](lecture-python-advanced.myst/dyn_stack.md) | 3.5 | 4.0 | 6.5 | 4.5 | 10.0 | 7.5 | 10.0 | **6.6** | 3.5 |
...
| dp | [lagrangian_lqdp](lecture-dp/lagrangian_lqdp.md) | 3.0 | 3.0 | 6.5 | — | 10.0 | 7.5 | 10.0 | **6.7** | 3.0 |
| dp | [lqcontrol](lecture-dp/lqcontrol.md) | 4.0 | 3.0 | 7.5 | 4.5 | 10.0 | 8.0 | 10.0 | **6.7** | 3.0 |
| advanced | [robustness](lecture-python-advanced.myst/robustness.md) | 3.0 | 3.0 | 7.0 | 6.5 | 10.0 | 7.5 | 10.0 | **6.7** | 3.0 |
| python.myst | [lagrangian_lqdp](lecture-python.myst/lagrangian_lqdp.md) | 3.0 | 3.0 | 6.5 | — | 10.0 | 7.5 | 10.0 | **6.7** | 3.0 |
| python.myst | [linear_models](lecture-python.myst/linear_models.md) | 3.0 | 3.0 | 7.5 | 7.5 | — | 9.0 | 10.0 | **6.7** | 3.0 |
| python.myst | [stats_examples](lecture-python.myst/stats_examples.md) | 3.0 | 4.5 | 7.0 | 6.5 | — | 10.0 | 10.0 | **6.8** | 3.0 |
| dp | [dyn_stack](lecture-dp/dyn_stack.md) | 4.0 | 5.0 | 7.0 | 4.5 | 10.0 | 7.5 | 10.0 | **6.9** | 4.0 |
...
| advanced | [calvo](lecture-python-advanced.myst/calvo.md) | 3.0 | 5.5 | 7.0 | 7.0 | 8.5 | 8.0 | 10.0 | **7.0** | 3.0 |
...
| advanced | [calvo_machine_learn](lecture-python-advanced.myst/calvo_machine_learn.md) | 3.5 | 3.0 | 5.5 | 8.0 | 10.0 | 10.0 | 10.0 | **7.1** | 3.0 |
| advanced | [stationary_densities](lecture-python-advanced.myst/stationary_densities.md) | 4.0 | 6.0 | 7.0 | 6.0 | 9.0 | 7.5 | 10.0 | **7.1** | 4.0 |
...
| python.myst | [prob_meaning](lecture-python.myst/prob_meaning.md) | 3.0 | 7.5 | 7.5 | 4.5 | — | 10.0 | 10.0 | **7.1** | 3.0 |
| python.myst | [sargent_surico](lecture-python.myst/sargent_surico.md) | 5.5 | 5.5 | 4.5 | 4.0 | 10.0 | 10.0 | 10.0 | **7.1** | 4.0 |
...
| advanced | [subjective_beliefs_business_cycles](lecture-python-advanced.myst/subjective_beliefs_business_cycles.md) | 3.0 | 3.0 | 8.5 | 7.0 | 9.0 | 10.0 | 10.0 | **7.2** | 3.0 |
...
| python.myst | [affine_risk_prices](lecture-python.myst/affine_risk_prices.md) | 4.5 | 4.0 | 8.5 | 5.0 | 9.0 | 10.0 | 10.0 | **7.3** | 4.0 |
...
| advanced | [lqramsey](lecture-python-advanced.myst/lqramsey.md) | 4.0 | 3.0 | 7.5 | 7.0 | 10.0 | 10.0 | 10.0 | **7.4** | 3.0 |
| advanced | [orth_proj](lecture-python-advanced.myst/orth_proj.md) | 4.0 | 3.0 | 10.0 | 7.0 | 10.0 | 8.0 | 10.0 | **7.4** | 3.0 |
| advanced | [risk_aversion_or_mistaken_beliefs](lecture-python-advanced.myst/risk_aversion_or_mistaken_beliefs.md) | 5.0 | 3.0 | 10.0 | 3.5 | 10.0 | 10.0 | 10.0 | **7.4** | 3.0 |
...
| advanced | [gorman_heterogeneous_households](lecture-python-advanced.myst/gorman_heterogeneous_households.md) | 3.0 | 8.0 | 6.5 | 5.0 | 10.0 | 10.0 | 10.0 | **7.5** | 3.0 |
...
| python.myst | [information_market_equilibrium](lecture-python.myst/information_market_equilibrium.md) | 4.0 | 4.0 | 7.0 | 7.5 | 10.0 | 10.0 | 10.0 | **7.5** | 4.0 |
...
| advanced | [doubts_or_variability](lecture-python-advanced.myst/doubts_or_variability.md) | 4.0 | 3.0 | 8.5 | 9.0 | 9.0 | 10.0 | 10.0 | **7.6** | 3.0 |
| advanced | [dovis_accounting_mf](lecture-python-advanced.myst/dovis_accounting_mf.md) | 4.0 | 4.5 | 10.0 | 4.5 | 10.0 | 10.0 | 10.0 | **7.6** | 4.0 |
| advanced | [hansen_richard_1987](lecture-python-advanced.myst/hansen_richard_1987.md) | 3.0 | 4.0 | 6.5 | 9.5 | 10.0 | 10.0 | 10.0 | **7.6** | 3.0 |
...
| python.myst | [hansen_singleton_1983](lecture-python.myst/hansen_singleton_1983.md) | 6.5 | 3.0 | 8.5 | 9.5 | 10.0 | 10.0 | — | **7.9** | 3.0 |
| python.myst | [lln_clt](lecture-python.myst/lln_clt.md) | 7.0 | 3.0 | 8.5 | 7.0 | 10.0 | 10.0 | 10.0 | **7.9** | 3.0 |
...
| programming | [python_oop](lecture-python-programming/python_oop.md) | 3.0 | 10.0 | 7.5 | 7.5 | — | 10.0 | 10.0 | **8.0** | 3.0 |
...
| dp | [ifp_egm](lecture-dp/ifp_egm.md) | 3.5 | 9.0 | 7.5 | 6.5 | 10.0 | 10.0 | 10.0 | **8.1** | 3.5 |
...
| python.myst | [ifp_egm](lecture-python.myst/ifp_egm.md) | 3.5 | 9.5 | 7.5 | 6.5 | 10.0 | 10.0 | 10.0 | **8.1** | 3.5 |
| python.myst | [likelihood_ratio_process_2](lecture-python.myst/likelihood_ratio_process_2.md) | 5.5 | 10.0 | 10.0 | 4.0 | 7.5 | 10.0 | 10.0 | **8.1** | 4.0 |
...
14. **Shared lectures between `lecture-dp` and `lecture-python.myst`.** 31 filenames
    ...
    `mccall_model_with_separation`, `os_numerical`. Those 6 account for 223 of the corpus's
    18,752 findings — **1.2 % genuinely counted twice**, which is the honest size of the
