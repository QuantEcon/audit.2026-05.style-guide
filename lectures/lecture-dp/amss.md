...
6. Switch the 8 emphasis bolds to italic and turn the bold sentence at 245 into ordinary text; convert `{\cal S}` to $S$ at 612 and 624; convert the `pmatrix` at 802 and the `matrix` at 815 to `bmatrix` (qe-math-003 x2); and brace the bare `\mathbb E_{t}` at 451 (qe-math-010 (proposed)).
