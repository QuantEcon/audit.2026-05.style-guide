...
|--------------|-------|---------------|
| Writing      | 4/10  | `qe-writing-006` ×3; `qe-writing-001` ×3; `qe-writing-005` ×4, +3 more. |
...
- **[qe-writing-006]** — Capitalize lecture titles properly. *Count:* 3. *Lines:* 76, 154, 395. *Example:* H2 Title Case: 'The Model' (Model).
