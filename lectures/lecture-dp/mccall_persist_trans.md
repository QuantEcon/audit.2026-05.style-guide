...
3. Brace the blackboard operators - `\mathbb E_z` -> `\mathbb{E}_z` at 100, 104, 116, 129 and 136, and `\mathbb R` -> `\mathbb{R}` at 142 (qe-math-010 (proposed)). The scanner reports 0 math violations here and that is a defect, not a clean bill of health - see scanner_doubts.
