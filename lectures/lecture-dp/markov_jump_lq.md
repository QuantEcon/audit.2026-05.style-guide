...
6. Convert the raw `python-intro.quantecon.org/lqcontrol.html` URL at 37 to `` {doc}`lqcontrol` `` (qe-link-002), make the three narrative citations `{cite:t}` (39, 41, 43, qe-ref-001 x3), write `\mathbb{P}` in place of `\Pr` at 288 (qe-math-010 (proposed)), replace `{\cal N}` with `N` at 180 (qe-math-011 (proposed)) and 'i.i.d.' with 'IID' at 179 (qe-writing-009 (proposed)).
