...
5. Add braces at line 88 - `{\mathbb E}` should be `\mathbb{E}` (qe-math-010 (proposed)) - and add mystnb caption/name metadata to the 4 code-cell figures (354, 678, 696, 714) (qe-fig-005 x4).
