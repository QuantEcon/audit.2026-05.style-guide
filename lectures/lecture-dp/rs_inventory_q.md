...
6. Brace the five `\mathbb E` at 66, 84, 418, 461 and 479 (qe-math-010 (proposed), proposed) - and note that the same operator is already correctly written `\mathbb{E}` at 670, 760 and 768, so the file only needs to be made consistent with itself.
