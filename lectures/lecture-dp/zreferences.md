...
2. Add the missing newline at end of file: `lecture-python-intro`, `lecture-python.myst` and `lecture-python-advanced.myst` all carry a byte-identical `zreferences.md`, and this copy differs from them in exactly that one character.
