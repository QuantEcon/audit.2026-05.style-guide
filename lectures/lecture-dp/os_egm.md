...
### High severity
- **[qe-math-002]** — Use \top for transpose notation. *Count:* 2. *Lines:* 74, 124. *Example:* apostrophe transpose `u'`.
...
- **[qe-fig-008]** — Use lw=2 for line charts. *Count:* 1. *Lines:* 324. *Example:* plot() without lw=.
