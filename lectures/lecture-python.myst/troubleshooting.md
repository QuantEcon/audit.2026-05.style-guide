...
|--------------|-------|---------------|
| Writing      | 7/10 | Section headings use Title Case instead of sentence case. |
...
## Recommended actions
1. Address `qe-writing-006`: Section headings use Title Case instead of sentence case.
