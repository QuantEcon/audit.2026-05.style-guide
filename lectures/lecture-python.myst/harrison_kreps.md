...
5. Fix the math typography: `\max` instead of `$max$` at 323, one row separator inside `bmatrix` (`\\` at 114-125 versus `\cr` at 253-267), `s_t \in S = \{0,1\}` instead of `$S \in \{0, 1\}$` at 84, and braces on `\mathbb P` at 106 (qe-math-010 (proposed)).
