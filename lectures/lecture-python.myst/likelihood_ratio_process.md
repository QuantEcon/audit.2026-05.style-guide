...
| Figures      | 3.5/10 | `qe-fig-005` ×16; `qe-fig-003` ×9; `qe-fig-006` ×4, +2 more. |
...
- **[qe-fig-005]** — Descriptive figure names for cross-referencing. *Count:* 16. *Lines:* 136, 225, 344, 354, 485, 529, 581, 642, 754, 1008, …. *Example:* code-cell figure without mystnb figure metadata.
- **[qe-fig-008]** — Use lw=2 for line charts. *Count:* 20. *Lines:* 227, 346, 355, 556, 557, 593, 596, 651, 800, 802, …. *Example:* plot() without lw=.
...
2. `qe-fig-005` — Descriptive figure names for cross-referencing (16 occurrences).
