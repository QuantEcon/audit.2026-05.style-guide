...
2. Add braces to the 52 blackboard operators (237, 242, 252, 262, 263, 264, 265, 272, 277, 297 and 42 more) - the file contains no `\mathbb` at all, so every `E\left[`, `\Pr` and `Var(` needs converting to `\mathbb{E}`, `\mathbb{P}`, `\mathbb{V}` (qe-math-010 (proposed)), and while doing it put the four parenthesised events at 955, 961 and 1077 into braces to match 402-425.
