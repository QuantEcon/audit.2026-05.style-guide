...
5. Write `\mathbb{V}` for the two `\operatorname{Var}` (354, 355) and add braces to `\mathbb E` at 706 and 711 (qe-math-010 (proposed)); switch the citation at 512 to `{cite:t}`; and close the five double spaces (60, 364, 518, 552).
