...
- **[qe-ref-001]** — Use correct citation style. *Count:* 8. *Lines:* 272, 443, 455, 518, 598, 639, 726. *Example:* {cite} in author position: '{cite}`DMD_book` and'.
...
4. `qe-ref-001` — Use correct citation style (8 occurrences).
