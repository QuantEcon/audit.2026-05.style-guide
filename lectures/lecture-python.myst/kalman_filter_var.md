...
| Code         | 5.5/10 | `qe-code-002` ×13; `qe-code-001` ×5. |
...
- **[qe-code-002]** — Use Unicode symbols for Greek letters in code. *Count:* 13. *Lines:* 682, 687, 717, 761, 812, 815, 817, 825, 828, 830, …. *Example:* spelled-out `Sigma`.
