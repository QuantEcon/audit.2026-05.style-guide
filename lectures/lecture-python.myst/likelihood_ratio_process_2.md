...
- **[qe-ref-001]** — Use correct citation style. *Count:* 7. *Lines:* 37, 412, 838. *Example:* {cite} in author position: '{cite}`alchian1950uncertainty` and'.
...
- **[qe-fig-008]** — Use lw=2 for line charts. *Count:* 4. *Lines:* 647, 657, 1526, 1528. *Example:* plot() without lw=.
...
3. `qe-ref-001` — Use correct citation style (7 occurrences).
