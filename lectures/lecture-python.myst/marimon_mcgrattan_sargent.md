...
| Figures      | 6.5/10 | `qe-fig-003` ×4; `qe-fig-005` ×1; `qe-fig-001` ×2, +1 more. |
...
### Low severity
- **[qe-fig-005]** — Descriptive figure names for cross-referencing. *Count:* 1. *Lines:* 958. *Example:* code-cell figure without mystnb figure metadata.
