...
- **[qe-ref-001]** — Use correct citation style. *Count:* 6. *Lines:* 301, 402, 430, 463. *Example:* {cite} in author position: '{cite}`SamuelsonSolow1960` found'.
...
5. `qe-fig-004` — Caption formatting conventions (6 occurrences).
