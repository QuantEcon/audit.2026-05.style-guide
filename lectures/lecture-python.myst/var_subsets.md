...
| Code         | 5/10  | `qe-code-002` ×57; `qe-code-001` ×6. |
...
- **[qe-code-002]** — Use Unicode symbols for Greek letters in code. *Count:* 57. *Lines:* 520, 521, 522, 523, 528, 529, 534, 535, 537, 539, …. *Example:* spelled-out `Sigma`.
