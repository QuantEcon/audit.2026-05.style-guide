...
### High severity
- **[qe-code-002]** — Use Unicode symbols for Greek letters in code. *Count:* 9. *Lines:* 57, 231, 233, 445, 451, 462, 463, 677. *Example:* spelled-out `beta`.
...
6. `qe-code-002` — Use Unicode symbols for Greek letters in code (9 occurrences).
7. `qe-math-003` — Use square brackets for matrix notation (4 occurrences).
