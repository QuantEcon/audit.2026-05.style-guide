...
| Figures      | 4/10  | `qe-fig-003` ×16; `qe-fig-005` ×8; `qe-fig-001` ×12, +1 more. |
...
- **[qe-fig-005]** — Descriptive figure names for cross-referencing. *Count:* 8. *Lines:* 254, 280, 404, 1095, 1132, 1176, 1787, 1860. *Example:* code-cell figure without mystnb figure metadata.
