...
6. Fix the prose: repair the clause at 691-693, restate 708-714 so the subject and predicate are not separated by a bullet list, write 'IID' at 713 (qe-writing-009 (proposed)), split the two-sentence paragraph at 937 (qe-writing-001), and either answer the question at 525 or promote it to an exercise.
