...
| Math         | 5.5/10 | `qe-math-010` (proposed) ×12. |
...
1. `qe-math-010` (proposed) — Blackboard \mathbb{P}, \mathbb{E}, \mathbb{V} with braces (12 occurrences).
...
4. `qe-writing-008` — Remove excessive whitespace between words (29 occurrences).
