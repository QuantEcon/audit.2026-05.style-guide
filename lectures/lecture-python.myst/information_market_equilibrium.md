...
| Math         | 3/10  | `qe-math-010` (proposed) ×7; `qe-math-002` ×6; `qe-math-009` ×3. |
...
2. Add braces to the bare expectation at 1567 (`E_h[\log L_t]` -> `\mathbb{E}_h`) and replace `\Pr(` with `\mathbb{P}` in the two axis labels at 601 and 1295 (qe-math-010 (proposed), proposed); write "IID" at 751 and 757 (qe-writing-009 (proposed), proposed), dropping the bold on it at 751.
