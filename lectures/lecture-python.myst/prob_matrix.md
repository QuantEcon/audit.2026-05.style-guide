...
### Medium severity
- **[qe-writing-A1]** — Uses "i.i.d." or "iid" in text rather than "IID". *Examples:* lines 134, 137. *Count:* 4 occurrences.
- **[qe-math-A5]** — Multiplication written with `*` rather than `\cdot` or juxtaposition. *Example:* line 1126. *Count:* 3.
...
2. Address `qe-math-A5`: Multiplication written with `*` rather than `\cdot` or juxtaposition.
