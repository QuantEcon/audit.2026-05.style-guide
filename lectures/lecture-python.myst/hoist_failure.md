...
5. Write probabilities as `\mathbb{P}` with braces for events: `\Pr(X = j)` at 168 and 174 become `\mathbb{P}\{X = j\}` (qe-math-010, proposed; qe-math-014, proposed), and the plain `P(\cdot)` from 498 onward becomes `\mathbb{P}(\cdot)`.
