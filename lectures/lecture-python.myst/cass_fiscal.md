...
| Figures      | 4/10  | `qe-fig-003` ×10; `qe-fig-005` ×9; `qe-fig-008` ×11, +1 more. |
...
- **[qe-fig-005]** — Descriptive figure names for cross-referencing. *Count:* 9. *Lines:* 809, 856, 900, 950, 1054, 1383, 1631, 1686, 1723. *Example:* code-cell figure without mystnb figure metadata.
