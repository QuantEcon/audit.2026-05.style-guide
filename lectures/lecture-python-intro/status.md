...
|--------------|-------|---------------|
| Writing      | 9/10  | Auto-generated stats page; minor mid-sentence inline-code phrasing. |
| Math         | N/A   | no math content |
| Code         | 9/10  | two `code-cell` blocks running `!python --version` / `!conda list`; `:tags: [hide-output]` used appropriately. |
| JAX          | out of scope | — |
