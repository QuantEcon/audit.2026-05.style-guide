...
| Figures      | 5/10  | `qe-fig-005` ×5; `qe-fig-004` ×6; `qe-fig-002` ×5, +1 more. |
...
- **[qe-fig-004]** — Caption formatting conventions. *Count:* 6. *Lines:* 89, 238, 248, 401, 507, 786. *Example:* Title Case caption (Aircraft, Network).
